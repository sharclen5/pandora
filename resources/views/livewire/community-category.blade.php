<div>
    ...
    <div class="overflow-y-auto px-3 h-full">
        ...
        @foreach ($categories as $ctgrs )
            <a href="{{ route('community', $ctgrs->id) }}"
        ...
        <button data-modal-target="crud-modal" data-modal-toggle="crud-modal"
            class="text-white inline-flex mb-20 items-center bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">
