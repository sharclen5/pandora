<div>
    <div id="delete{{ $commun->id }}allModal" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
        ...
        <div class="relative p-4 text-center bg-white rounded-lg shadow sm:p-5">
            ...
            <p class="mb-4 text-gray-500">Are you sure you want to delete this {{ $commun->name }}?This action cannot be
                undone.
            </p>
            <div class="flex justify-center items-center space-x-4">
                <button data-modal-toggle="delete{{ $commun->id }}allModal" type="button"
                    ...
                    cancel</button>
                <button type="submit" wire:click="deleteCommunity()"
