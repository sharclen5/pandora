      ...
      <div class="max-w-md w-full p-6">
        ...
        <form action="{{ route('register') }}" method="POST" class="space-y-8">
          ...
          <div>
            ...
            <input type="email" id="email" name="email" class="mt-1 p-2 w-full border-blue-800 rounded-md bg-blue-900 focus:border-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-300 transition-colors duration-300">
          </div>
          <div>
