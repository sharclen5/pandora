<div id="update{{ $commun->id }}Modal" tabindex="-1" aria-hidden="true"
        ...
        <form class="p-4 md:p-5">
            <div class="grid gap-4 mb-4 grid-cols-2">
                ...
                <div class="col-span-2 sm:col-span-1">
                    ...
                    <input type="textr" name="tagline" id="tagline" wire:model="tagline"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5"
                ...
                <div class="col-span-2 sm:col-span-1">
                    <label for="category"
                        ...
                        <button id="category{{ $commun->id }}Button" data-dropdown-toggle="category{{ $commun->id }}"
                    ...
                    <!-- Dropdown menu -->
                    <div id="category{{ $commun->id }}" class="z-10 hidden bg-white rounded-lg shadow w-60 dark:bg-gray-700">
                ...
                <div class="col-span-2">
                    ...
                    <textarea id="description" rows="1" wire:model="description"
                        class="block p-2.5 w-full h-40 text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500"
                ...
                <div class="col-span-2">
                    <label for="description"
                        ...
                        Guidelines</label>
                    <textarea id="description" rows="4" wire:model="guide"
                        class="block p-2.5 w-full h-40 text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500"
                        placeholder="Rules and Guidelines"></textarea>
                </div>
            </div>
            <button type="submit" wire:click.prevent="updateCommunity()"
