            ...
            <div class="px-4 xl:px-12 py-2 flex w-full items-center">
                ...
                <div class="hidden xl:flex items-center space-x-5">
                    ...
                    <button id="dropdownNotificationButton" data-dropdown-toggle="dropdownNotification"
                        ...
                        type="button">
                        <svg class="text-white w-5 h-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                            viewBox="0 0 14 20">
                            <path
                        ...
                        <div
                            class="absolute block w-3 h-3 bg-red-500 border-2 border-white rounded-full -top-0.5 start-2.5 dark:border-gray-900 animate-pulse">
                        </div>
                    </button>
