<x-layout>
    ...
    <div class="w-full flex flex-col gap-5 px-3 md:px-16 lg:px-28 md:flex-row text-white">
        <aside class="hidden py-4 md:w-1/3 lg:w-1/4 md:block">
            <div class="sticky flex flex-col gap-2 p-4 text-sm border-r border-indigo-100 top-12 h-screen">
                ...
                <a href="#" class="flex items-center px-3 py-2.5 font-bold bg-blue-700  text-white border rounded-full">
                    Public Profile
                </a>
                <a href="#"
                        ...
                        <div class="items-center mt-8 sm:mt-14 text-[#202142]">
                            ...
                            <div
                                ...
                                <div class="w-full">
                                    <label for="first_name"
                                        class="block mb-2 text-sm font-medium text-white dark:text-white">Your
                                        first name</label>
                            ...
                            <div class="mb-2 sm:mb-6">
                                <label for="profession"
                                    class="block mb-2 text-sm font-medium text-white dark:text-white">Profession</label>
                            ...
                            <div class="mb-6">
                                <label for="message"
                                    class="block mb-2 text-sm font-medium text-white dark:text-white">Bio</label>
