        ...
        <div class="relative p-4 w-full max-w-7xl max-h-full">
            ...
            <div class="relative text-white bg-white rounded-lg shadow dark:bg-gray-700 flex">
                ...
                <div class="w-1/4 bg-gray-200 dark:bg-gray-500">
                    ...
                    <div class="flex justify-center items-center mt-72 mb-8">
                ...
                <div class="w-3/4">
                    ...
                    <div class="p-4 md:p-5 space-y-2">
                        ...
                        <p class="text-base leading-relaxed text-white">
                            Tech Innovators is a vibrant community where tech enthusiasts from diverse backgrounds come
                            together to share knowledge, collaborate on innovative projects, and explore the latest
                            advancements in technology. Our mission is to foster a forward-thinking environment that
                            inspires creativity, drives technological progress, and builds a network of like-minded
