<x-layout>
    ...
    <div id="welcome" class="mt-36 flex inset-x-0 flex-col items-center justify-center px-4 sm:px-6 lg:px-8">
        ...
        <button type="button"
            class="mt-20 text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm sm:text-base md:text-xl px-4 sm:px-6 md:px-10 py-2 sm:py-2.5 md:py-3.5 text-center me-2 mb-2">Get
            Started</button>
        <p class="mb-48"></p>
