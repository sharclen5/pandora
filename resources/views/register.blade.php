    ...
    <div class="w-full lg:w-1/2 text-white flex items-center justify-center">
     ...
     <div class="highlight-box border-2 border-blue-500 rounded-md px-10 py-6 max-w-lg w-full mx-auto box">
      <div class="max-w-md w-full p-6">
        <img src="minisui.png" alt="" class="w-24 h-24 mx-auto mb-4">
        <h1 class="text-3xl font-semibold mb-6 text-center">Join Now</h1>
        <h1 class="text-sm font-semibold mb-6 text-center">Explore and grasp the possibility right now </h1>
        ...
        <div class="mt-4 text-sm text-center">
          <p>Already have an account? <a href="#" class=" hover:underline">Login here</a>
          </p>
        </div>
      </div>
     </div>
